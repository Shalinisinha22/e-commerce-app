...
function Terms() {
  return (
    <div class="about-container">
      <h3 style={{ color: "#4cd137" }}>Terms And Condition</h3>
      <div class="about-content">
        <h3>OVERVIEW</h3>
        <p>
          This website is operated by Matardana. Throughout the site, the terms
          “we”, “us” and “our” refer to Matardana. Matardana offers this
          ...
          customers, merchants, and/ or contributors of content.<br></br> Please
          ...
          <br></br> Any new features or tools which are added to the current
      ...
      <div class="about-points">
        ...
        <p>
          In no case shall Matardana, our
      ...
      <div class="about-points">
        ...
        <p>
          You agree to indemnify, defend and hold harmless Matardana and our parent, subsidiaries, affiliates,
      ...
      <div class="about-points">
        ...
        <p>
          ...
          laws of India and jurisdiction of Patna Bihar.
        </p>
      </div>
...
Questions about the Terms of Service should be sent to us at  <span style={{color:"green"}}>matardana@gmail.com</span>.</p>
      </div>
